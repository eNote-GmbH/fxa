...
export default async function Error({ params }: { params: CheckoutParams }) {
  ...
  return (
    <>
      ...
      <header className="subscription-title page-title-container">
      ...
      {/* body */}
      <article className="component-card border-t-0 mb-6 pt-4rounded-t-lg text-grey-600 px-12 pb-12">
        {/* main content */}
        <section className="flex flex-col items-center justify-center">
          ...
          <div className="py-0 text-grey-400 mb-16 px-7 text-center">
