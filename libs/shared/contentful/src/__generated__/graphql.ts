...
export type CouponConfig = Entry & {
  ...
  stripePromotionCodesCollection?: Maybe<CouponConfigStripePromotionCodesCollection>;
  sys: Sys;
};
...
/** Additional Coupon configuration options that are not currently supported by Stripe. [See type definition](https://app.contentful.com/spaces/l7gqxxg5i1gg/content_types/couponConfig) */
export type CouponConfigStripePromotionCodesCollectionArgs = {
  limit?: InputMaybe<Scalars['Int']['input']>;
  locale?: InputMaybe<Scalars['String']['input']>;
  order?: InputMaybe<
    Array<InputMaybe<CouponConfigStripePromotionCodesCollectionOrder>>
  >;
  preview?: InputMaybe<Scalars['Boolean']['input']>;
  skip?: InputMaybe<Scalars['Int']['input']>;
  where?: InputMaybe<StripePromotionCodeFilter>;
};
...
export type CouponConfigFilter = {
  ...
  internalName_not_in?: InputMaybe<
    Array<InputMaybe<Scalars['String']['input']>>
  >;
  stripePromotionCodes?: InputMaybe<CfStripePromotionCodeNestedFilter>;
  stripePromotionCodesCollection_exists?: InputMaybe<
...
export type CouponConfigStripePromotionCodesCollection = {
  __typename?: 'CouponConfigStripePromotionCodesCollection';
  items: Array<Maybe<StripePromotionCode>>;
  limit: Scalars['Int']['output'];
  skip: Scalars['Int']['output'];
  total: Scalars['Int']['output'];
};

export enum CouponConfigStripePromotionCodesCollectionOrder {
  CouponIdAsc = 'couponId_ASC',
  CouponIdDesc = 'couponId_DESC',
  InternalNameAsc = 'internalName_ASC',
  InternalNameDesc = 'internalName_DESC',
  PromotionCodeIdAsc = 'promotionCodeId_ASC',
  PromotionCodeIdDesc = 'promotionCodeId_DESC',
  SysFirstPublishedAtAsc = 'sys_firstPublishedAt_ASC',
  SysFirstPublishedAtDesc = 'sys_firstPublishedAt_DESC',
  SysIdAsc = 'sys_id_ASC',
  SysIdDesc = 'sys_id_DESC',
...
export type Purchase = Entry & {
  ...
  stripePlanChoicesCollection?: Maybe<PurchaseStripePlanChoicesCollection>;
  sys: Sys;
};
...
/** Purchase flow related configuration options. [See type definition](https://app.contentful.com/spaces/l7gqxxg5i1gg/content_types/purchase) */
export type PurchaseStripePlanChoicesCollectionArgs = {
  limit?: InputMaybe<Scalars['Int']['input']>;
  locale?: InputMaybe<Scalars['String']['input']>;
  order?: InputMaybe<
    Array<InputMaybe<PurchaseStripePlanChoicesCollectionOrder>>
  >;
  preview?: InputMaybe<Scalars['Boolean']['input']>;
  skip?: InputMaybe<Scalars['Int']['input']>;
  where?: InputMaybe<StripePlanFilter>;
};
...
export type PurchaseFilter = {
  ...
  stripePlanChoices?: InputMaybe<CfStripePlanNestedFilter>;
  stripePlanChoicesCollection_exists?: InputMaybe<Scalars['Boolean']['input']>;
  sys?: InputMaybe<SysFilter>;
};
...
export type PurchaseStripePlanChoicesCollection = {
  __typename?: 'PurchaseStripePlanChoicesCollection';
  items: Array<Maybe<StripePlan>>;
  limit: Scalars['Int']['output'];
  skip: Scalars['Int']['output'];
  total: Scalars['Int']['output'];
};

export enum PurchaseStripePlanChoicesCollectionOrder {
  InternalNameAsc = 'internalName_ASC',
  InternalNameDesc = 'internalName_DESC',
  ...
  StripeProductIdAsc = 'stripeProductId_ASC',
  StripeProductIdDesc = 'stripeProductId_DESC',
  StripeProductNameAsc = 'stripeProductName_ASC',
  StripeProductNameDesc = 'stripeProductName_DESC',
  SysFirstPublishedAtAsc = 'sys_firstPublishedAt_ASC',
  SysFirstPublishedAtDesc = 'sys_firstPublishedAt_DESC',
  SysIdAsc = 'sys_id_ASC',
  SysIdDesc = 'sys_id_DESC',
...
export type Query = {
  ...
  stripePlanCollection?: Maybe<StripePlanCollection>;
  stripePromotionCode?: Maybe<StripePromotionCode>;
  stripePromotionCodeCollection?: Maybe<StripePromotionCodeCollection>;
...
export type QueryStripePlanArgs = {
  id: Scalars['String']['input'];
  locale?: InputMaybe<Scalars['String']['input']>;
  preview?: InputMaybe<Scalars['Boolean']['input']>;
};

export type QueryStripePlanCollectionArgs = {
  limit?: InputMaybe<Scalars['Int']['input']>;
  locale?: InputMaybe<Scalars['String']['input']>;
  order?: InputMaybe<Array<InputMaybe<StripePlanOrder>>>;
  preview?: InputMaybe<Scalars['Boolean']['input']>;
  skip?: InputMaybe<Scalars['Int']['input']>;
  where?: InputMaybe<StripePlanFilter>;
};
...
export type QueryStripePromotionCodeCollectionArgs = {
  limit?: InputMaybe<Scalars['Int']['input']>;
  locale?: InputMaybe<Scalars['String']['input']>;
  order?: InputMaybe<Array<InputMaybe<StripePromotionCodeOrder>>>;
  preview?: InputMaybe<Scalars['Boolean']['input']>;
  skip?: InputMaybe<Scalars['Int']['input']>;
  where?: InputMaybe<StripePromotionCodeFilter>;
};
 ...
 *
 * Synced Stripe Product and Stripe Plan information used by other content types. [See type definition](https://app.contentful.com/spaces/l7gqxxg5i1gg/content_types/stripePlan)
 */
export type StripePlan = Entry & {
  __typename?: 'StripePlan';
  contentfulMetadata: ContentfulMetadata;
  internalName?: Maybe<Scalars['String']['output']>;
  linkedFrom?: Maybe<StripePlanLinkingCollections>;
  stripeId?: Maybe<Scalars['String']['output']>;
  stripeProductId?: Maybe<Scalars['String']['output']>;
  stripeProductName?: Maybe<Scalars['String']['output']>;
  sys: Sys;
};
 ...
 * Synced Stripe Product and Stripe Plan information used by other content types. [See type definition](https://app.contentful.com/spaces/l7gqxxg5i1gg/content_types/stripePlan)
 */
export type StripePlanInternalNameArgs = {
  locale?: InputMaybe<Scalars['String']['input']>;
};
 ...
 * Synced Stripe Product and Stripe Plan information used by other content types. [See type definition](https://app.contentful.com/spaces/l7gqxxg5i1gg/content_types/stripePlan)
 */
export type StripePlanLinkedFromArgs = {
  allowedLocales?: InputMaybe<Array<InputMaybe<Scalars['String']['input']>>>;
};
 ...
 * Synced Stripe Product and Stripe Plan information used by other content types. [See type definition](https://app.contentful.com/spaces/l7gqxxg5i1gg/content_types/stripePlan)
 */
export type StripePlanStripeIdArgs = {
  locale?: InputMaybe<Scalars['String']['input']>;
};
 ...
 * Synced Stripe Product and Stripe Plan information used by other content types. [See type definition](https://app.contentful.com/spaces/l7gqxxg5i1gg/content_types/stripePlan)
 */
export type StripePlanStripeProductIdArgs = {
  locale?: InputMaybe<Scalars['String']['input']>;
};
 ...
 * Synced Stripe Product and Stripe Plan information used by other content types. [See type definition](https://app.contentful.com/spaces/l7gqxxg5i1gg/content_types/stripePlan)
 */
export type StripePlanStripeProductNameArgs = {
  locale?: InputMaybe<Scalars['String']['input']>;
};

export type StripePlanCollection = {
  __typename?: 'StripePlanCollection';
  items: Array<Maybe<StripePlan>>;
  limit: Scalars['Int']['output'];
  skip: Scalars['Int']['output'];
  total: Scalars['Int']['output'];
...
export type StripePlanFilter = {
  AND?: InputMaybe<Array<InputMaybe<StripePlanFilter>>>;
  OR?: InputMaybe<Array<InputMaybe<StripePlanFilter>>>;
  contentfulMetadata?: InputMaybe<ContentfulMetadataFilter>;
  internalName?: InputMaybe<Scalars['String']['input']>;
  internalName_contains?: InputMaybe<Scalars['String']['input']>;
  internalName_exists?: InputMaybe<Scalars['Boolean']['input']>;
  ...
  stripeId_exists?: InputMaybe<Scalars['Boolean']['input']>;
  stripeId_in?: InputMaybe<Array<InputMaybe<Scalars['String']['input']>>>;
  stripeId_not?: InputMaybe<Scalars['String']['input']>;
  stripeId_not_contains?: InputMaybe<Scalars['String']['input']>;
  stripeId_not_in?: InputMaybe<Array<InputMaybe<Scalars['String']['input']>>>;
  stripeProductId?: InputMaybe<Scalars['String']['input']>;
  stripeProductId_contains?: InputMaybe<Scalars['String']['input']>;
  stripeProductId_exists?: InputMaybe<Scalars['Boolean']['input']>;
  stripeProductId_in?: InputMaybe<
  ...
  stripeProductId_not_in?: InputMaybe<
    Array<InputMaybe<Scalars['String']['input']>>
  >;
  stripeProductName?: InputMaybe<Scalars['String']['input']>;
  stripeProductName_contains?: InputMaybe<Scalars['String']['input']>;
  stripeProductName_exists?: InputMaybe<Scalars['Boolean']['input']>;
  stripeProductName_in?: InputMaybe<
    Array<InputMaybe<Scalars['String']['input']>>
  >;
  stripeProductName_not?: InputMaybe<Scalars['String']['input']>;
  stripeProductName_not_contains?: InputMaybe<Scalars['String']['input']>;
  stripeProductName_not_in?: InputMaybe<
    Array<InputMaybe<Scalars['String']['input']>>
  >;
  sys?: InputMaybe<SysFilter>;
};

export type StripePlanLinkingCollections = {
  __typename?: 'StripePlanLinkingCollections';
  entryCollection?: Maybe<EntryCollection>;
  purchaseCollection?: Maybe<PurchaseCollection>;
};

export type StripePlanLinkingCollectionsEntryCollectionArgs = {
  limit?: InputMaybe<Scalars['Int']['input']>;
  locale?: InputMaybe<Scalars['String']['input']>;
  preview?: InputMaybe<Scalars['Boolean']['input']>;
  skip?: InputMaybe<Scalars['Int']['input']>;
...
export type StripePlanLinkingCollectionsPurchaseCollectionArgs = {
  limit?: InputMaybe<Scalars['Int']['input']>;
  locale?: InputMaybe<Scalars['String']['input']>;
  order?: InputMaybe<
    Array<InputMaybe<StripePlanLinkingCollectionsPurchaseCollectionOrder>>
  >;
  preview?: InputMaybe<Scalars['Boolean']['input']>;
  skip?: InputMaybe<Scalars['Int']['input']>;
};

export enum StripePlanLinkingCollectionsPurchaseCollectionOrder {
  DescriptionAsc = 'description_ASC',
  DescriptionDesc = 'description_DESC',
  InternalNameAsc = 'internalName_ASC',
  InternalNameDesc = 'internalName_DESC',
 ...
 * !!!! Automatically Generated from Stripe - Do not modify !!!!
 *
 * Synced Stripe Coupon and Stripe Promotion Code information used by other content types. [See type definition](https://app.contentful.com/spaces/l7gqxxg5i1gg/content_types/stripePromotionCode)
 */
export type StripePromotionCode = Entry & {
  __typename?: 'StripePromotionCode';
  contentfulMetadata: ContentfulMetadata;
  couponId?: Maybe<Scalars['String']['output']>;
  discountDetails?: Maybe<Scalars['JSON']['output']>;
  internalName?: Maybe<Scalars['String']['output']>;
  linkedFrom?: Maybe<StripePromotionCodeLinkingCollections>;
  promotionCodeId?: Maybe<Scalars['String']['output']>;
  sys: Sys;
};
 ...
 * Synced Stripe Coupon and Stripe Promotion Code information used by other content types. [See type definition](https://app.contentful.com/spaces/l7gqxxg5i1gg/content_types/stripePromotionCode)
 */
export type StripePromotionCodeCouponIdArgs = {
  locale?: InputMaybe<Scalars['String']['input']>;
};
 ...
 * Synced Stripe Coupon and Stripe Promotion Code information used by other content types. [See type definition](https://app.contentful.com/spaces/l7gqxxg5i1gg/content_types/stripePromotionCode)
 */
export type StripePromotionCodeDiscountDetailsArgs = {
  locale?: InputMaybe<Scalars['String']['input']>;
};
 ...
 * Synced Stripe Coupon and Stripe Promotion Code information used by other content types. [See type definition](https://app.contentful.com/spaces/l7gqxxg5i1gg/content_types/stripePromotionCode)
 */
export type StripePromotionCodeInternalNameArgs = {
  locale?: InputMaybe<Scalars['String']['input']>;
};
 ...
 * Synced Stripe Coupon and Stripe Promotion Code information used by other content types. [See type definition](https://app.contentful.com/spaces/l7gqxxg5i1gg/content_types/stripePromotionCode)
 */
export type StripePromotionCodeLinkedFromArgs = {
  allowedLocales?: InputMaybe<Array<InputMaybe<Scalars['String']['input']>>>;
};
 ...
 * Synced Stripe Coupon and Stripe Promotion Code information used by other content types. [See type definition](https://app.contentful.com/spaces/l7gqxxg5i1gg/content_types/stripePromotionCode)
 */
export type StripePromotionCodePromotionCodeIdArgs = {
  locale?: InputMaybe<Scalars['String']['input']>;
};

export type StripePromotionCodeCollection = {
  __typename?: 'StripePromotionCodeCollection';
  items: Array<Maybe<StripePromotionCode>>;
  limit: Scalars['Int']['output'];
  skip: Scalars['Int']['output'];
  total: Scalars['Int']['output'];
...
export type StripePromotionCodeFilter = {
  AND?: InputMaybe<Array<InputMaybe<StripePromotionCodeFilter>>>;
  OR?: InputMaybe<Array<InputMaybe<StripePromotionCodeFilter>>>;
  contentfulMetadata?: InputMaybe<ContentfulMetadataFilter>;
  couponId?: InputMaybe<Scalars['String']['input']>;
  couponId_contains?: InputMaybe<Scalars['String']['input']>;
  couponId_exists?: InputMaybe<Scalars['Boolean']['input']>;
  couponId_in?: InputMaybe<Array<InputMaybe<Scalars['String']['input']>>>;
  couponId_not?: InputMaybe<Scalars['String']['input']>;
  couponId_not_contains?: InputMaybe<Scalars['String']['input']>;
  couponId_not_in?: InputMaybe<Array<InputMaybe<Scalars['String']['input']>>>;
  discountDetails_exists?: InputMaybe<Scalars['Boolean']['input']>;
  internalName?: InputMaybe<Scalars['String']['input']>;
  internalName_contains?: InputMaybe<Scalars['String']['input']>;
  internalName_exists?: InputMaybe<Scalars['Boolean']['input']>;
  internalName_in?: InputMaybe<Array<InputMaybe<Scalars['String']['input']>>>;
  ...
  promotionCodeId_contains?: InputMaybe<Scalars['String']['input']>;
  promotionCodeId_exists?: InputMaybe<Scalars['Boolean']['input']>;
  promotionCodeId_in?: InputMaybe<
    Array<InputMaybe<Scalars['String']['input']>>
  >;
  promotionCodeId_not?: InputMaybe<Scalars['String']['input']>;
  promotionCodeId_not_contains?: InputMaybe<Scalars['String']['input']>;
  promotionCodeId_not_in?: InputMaybe<
    Array<InputMaybe<Scalars['String']['input']>>
  >;
  sys?: InputMaybe<SysFilter>;
};

export type StripePromotionCodeLinkingCollections = {
  __typename?: 'StripePromotionCodeLinkingCollections';
  couponConfigCollection?: Maybe<CouponConfigCollection>;
  entryCollection?: Maybe<EntryCollection>;
};

export type StripePromotionCodeLinkingCollectionsCouponConfigCollectionArgs = {
  limit?: InputMaybe<Scalars['Int']['input']>;
  locale?: InputMaybe<Scalars['String']['input']>;
  order?: InputMaybe<
    Array<
      InputMaybe<StripePromotionCodeLinkingCollectionsCouponConfigCollectionOrder>
    >
  >;
  preview?: InputMaybe<Scalars['Boolean']['input']>;
  skip?: InputMaybe<Scalars['Int']['input']>;
...
export type StripePromotionCodeLinkingCollectionsEntryCollectionArgs = {
  limit?: InputMaybe<Scalars['Int']['input']>;
  locale?: InputMaybe<Scalars['String']['input']>;
  preview?: InputMaybe<Scalars['Boolean']['input']>;
  skip?: InputMaybe<Scalars['Int']['input']>;
...
export enum StripePromotionCodeLinkingCollectionsCouponConfigCollectionOrder {
  CountriesAsc = 'countries_ASC',
  CountriesDesc = 'countries_DESC',
  InternalNameAsc = 'internalName_ASC',
  InternalNameDesc = 'internalName_DESC',
...
export enum StripePromotionCodeOrder {
  CouponIdAsc = 'couponId_ASC',
  CouponIdDesc = 'couponId_DESC',
  InternalNameAsc = 'internalName_ASC',
  InternalNameDesc = 'internalName_DESC',
...
export type CfStripePlanNestedFilter = {
  AND?: InputMaybe<Array<InputMaybe<CfStripePlanNestedFilter>>>;
  OR?: InputMaybe<Array<InputMaybe<CfStripePlanNestedFilter>>>;
  contentfulMetadata?: InputMaybe<ContentfulMetadataFilter>;
  internalName?: InputMaybe<Scalars['String']['input']>;
  internalName_contains?: InputMaybe<Scalars['String']['input']>;
  internalName_exists?: InputMaybe<Scalars['Boolean']['input']>;
...
export type CfStripePromotionCodeNestedFilter = {
  AND?: InputMaybe<Array<InputMaybe<CfStripePromotionCodeNestedFilter>>>;
  OR?: InputMaybe<Array<InputMaybe<CfStripePromotionCodeNestedFilter>>>;
  contentfulMetadata?: InputMaybe<ContentfulMetadataFilter>;
  couponId?: InputMaybe<Scalars['String']['input']>;
  couponId_contains?: InputMaybe<Scalars['String']['input']>;
  couponId_exists?: InputMaybe<Scalars['Boolean']['input']>;
