...
export class LoginPage extends BaseLayout {
  ...
  get CWTSEngineBookmarks() {
    return this.page.getByText('Bookmarks', { exact: true });
  }
  ...
  get CWTSEnginePasswords() {
    return this.page.getByText('Passwords', { exact: true });
  }

  get CWTSEngineAddons() {
    return this.page.getByText('Add-ons', { exact: true });
  }

  get CWTSEngineOpenTabs() {
    return this.page.getByText('Open Tabs', { exact: true });
  }

  get CWTSEnginePreferences() {
    return this.page.getByText('Preferences', { exact: true });
  }

  get CWTSEngineCreditCards() {
    return this.page.getByText('Payment Methods', { exact: true });
  }

  get CWTSEngineAddresses() {
    return this.page.getByText('Addresses', { exact: true });
  }
