...
const DESCRIPTIONS = {
  ...
  atLeast18AtReg:
    'True if age submitted at signup is equal or higher than 18, false if under 18, and null if account created before this column was added or if COPPA is disabled. Used by some relying parties to verify if they need to perform another age check.',
  authAt:
