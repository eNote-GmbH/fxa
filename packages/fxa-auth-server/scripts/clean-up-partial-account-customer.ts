...
const init = async () => {
  ...
  // TBD: Is this needed? The returned DB references is no longer used since we don't need the account manager.
  //      I don't see where the knex connection is setup. Do we need that somewhere?
