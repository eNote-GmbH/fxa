  ...
  describe('processSubscription', () => {
    ...
    describe('success', () => {
      ...
      it('updates subscription', () => {
        expect(updateSubscriptionStub.calledWith(mockCustomer.id)).true;
      });
    ...
    describe('dry run', () => {
      ...
      it('does not update subscription', () => {
        expect(updateSubscriptionStub.calledWith(mockCustomer.id)).false;
      });
