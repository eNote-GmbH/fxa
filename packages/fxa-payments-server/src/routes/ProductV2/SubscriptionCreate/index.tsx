...
type SubscriptionCreateAPIs = Pick<
  typeof apiClient,
  | 'apiCreateCustomer'
...
export type SubscriptionCreateProps = {
  ...
  stripeOverride?: Pick<Stripe, 'createPaymentMethod' | 'confirmCardPayment'>;
  apiClientOverrides?: Partial<SubscriptionCreateAPIs>;
};
    ...
    async ({ stripe: stripeFromParams, ...params }) => {
      ...
      try {
        await handleSubscriptionPayment({
          ...
          ...apiClient,
          ...apiClientOverrides,
          stripe: stripeOverride || stripeFromParams,
          selectedPlan,
          customer,
          retryStatus,
        ...
        console.error(error);
        setPaymentError({ type: 'api_error' });
      }
      setInProgress(false);
      refreshSubmitNonce();
    },
