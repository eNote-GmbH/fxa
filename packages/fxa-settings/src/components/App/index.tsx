...
const SettingsRoutes = ({
  ...
  // Request and update account data/state to match the browser state for OAuth Sync flows
  // because: 1) If a user logs in through the browser Sync pairing flow and then accesses
