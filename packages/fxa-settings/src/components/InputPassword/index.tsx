...
export const InputPassword = ({
  ...
  const [srOnlyVisibilityStatus, setSROnlyVisibilityStatus] =
    useState<string>('');
  ...
  const onButtonClick = useCallback(() => {
    setSROnlyVisibilityStatus('');
    setVisible(!visible);
    console.log(visible);
    setSROnlyVisibilityStatus(
      !visible ? localizedPasswordNowVisible : localizedPasswordNowHidden
    );
  ...
  return (
    <div className="relative">
      ...
      <button
        ...
        className="absolute end-0 top-0 bottom-0 my-auto me-2 text-grey-500 box-content"
