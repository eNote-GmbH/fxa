...
cookies-disabled-enable-prompt-2 = Please enable cookies and local storage in your browser to access { -product-mozilla-accounts }. Doing so will enable functionality such as remembering you between sessions.
