...
describe('PageSigninRecoveryCode', () => {
  ...
  it('emits a metrics event on render', () => {
    ...
    expect(GleanMetrics.loginRecoveryCode.view).toBeCalledTimes(1);
  });
  ...
  it('emits metrics events on submit', async () => {
    ...
    await waitFor(() => {
      expect(GleanMetrics.loginRecoveryCode.submit).toBeCalledTimes(1);
      expect(GleanMetrics.loginRecoveryCode.success).toBeCalledTimes(1);
    });
  });
});
