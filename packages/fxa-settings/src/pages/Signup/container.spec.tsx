 ...
 *
 * The basic steps should e as follows:
 ...
 *  4. Write tests, be sure to mocks & spies are reset prior to each suite.
...
import SingupContainer, { SignupContainerIntegration } from './container';
...
async function render(text?: string) {
  ...
  await screen.findByText(text || 'sign up mock');
...
describe('sign-up-container', () => {
  ...
  describe('loading-states', () => {
    ...
    it('shows loading util account status query resolves', async () => {
      await render('loading spinner mock');
      expect(screen.queryByText('sign up mock')).toBeNull();
    });
  });
