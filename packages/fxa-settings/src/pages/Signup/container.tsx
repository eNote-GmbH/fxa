...
import { getCredentials, getCredentialsV2, getKeysV2 } from 'fxa-auth-client/lib/crypto';
...
import { KeyStretchExperiment } from '../../models/pages/signup/key-stretch-experiment';
      ...
      try {
        ...
        if (data) {
          return {
            data: {
              ...data,
              unwrapBKey: credentialsV2 ? credentialsV2.unwrapBKey : credentialsV1.unwrapBKey,
            }
          }
        }
