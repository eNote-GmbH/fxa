...
const SignupContainer = ({
  ...
  const temp2 = useValidatedQueryParams(SignupQueryParams);
  const { queryParamModel, validationError } = temp2;
  ...
  const temp = useMutation<BeginSignupResponse>(BEGIN_SIGNUP_MUTATION);
  const [beginSignup] = temp;
